...
void main(int argc, char* argv[]) {
    ...
    file.mainLoopIndex = 0;                        //track file read progress for error handling
...
void convertCommandToArgv(FileInfo *file, ErrorType* error)
{
    ...
    int* argLocBeginEnd;
    try{ argLocBeginEnd = new int[delimiters](); }
    catch (bad_alloc &param) { return; }
    ...
    try {file->fileArgv = new char*[delimiters](); }
    catch (bad_alloc &param) { return; }
